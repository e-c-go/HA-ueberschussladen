...
def pv_excess_control(automation_id, appliance_priority, export_power, pv_power, load_power, home_battery_level,
    ...
    # Überprüfen, ob der Switch aktiviert ist
    if _get_state("input_boolean.zaptec_uberschussladen") != "on":
        log.info("Überschussladen ist deaktiviert, da der Switch 'input_boolean.zaptec_uberschussladen' nicht aktiviert ist.")
        return
